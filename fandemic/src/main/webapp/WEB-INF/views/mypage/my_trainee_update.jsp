									...
									<td>
										...
										<div class="col">
											<input type="text" id="tr_name" name="tr_name"
												value="${TrList.tr_name }" readonly> <input
									...
									<td>
										<div class="col">
											...
											<select id="tr_branch1" name="tr_branch1" style="width: 80%">
												...
												<option value="가수"
													<c:if test="${TrList.tr_branch1=='가수'}">selected</c:if>>가수</option>
												<option value="모델"
													<c:if test="${TrList.tr_branch1=='모델'}">selected</c:if>>모델</option>
												<option value="개그"
											...
											<div class="col">
												<select id="tr_branch2" name="tr_branch2" style="width: 80%">
													...
													<option value="가수"
														<c:if test="${TrList.tr_branch2=='가수'}">selected</c:if>>가수</option>
													<option value="모델"
														<c:if test="${TrList.tr_branch2=='모델'}">selected</c:if>>모델</option>
													<option value="개그"
