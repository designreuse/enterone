		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<form method="post" action="${pageContext.request.contextPath}/audition/traineeupdatesend" encType="multipart/form-data">
								...
								<td>
									<div class="col">
										<textarea rows="5" cols="30" class="introduce" type="text"
											name="tr_content" id="tr_content" value="${trainee.tr_content}"></textarea>
									</div>
								</td>
							</tr>
							<tr>
