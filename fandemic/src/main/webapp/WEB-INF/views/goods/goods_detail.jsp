						...
						<div class="col-lg-6 col-md-6">
							<div class="product__details__text">
								...
								<ul>
									...
									<li style="font-size: 15px; line-height: 25px; margin-top: 20px;">
										<span>※ 본 콘텐츠는 생중계 프로그램으로 정확한 시작 및 종료 시각은 연결 상황에 따라 변동될 수 있으며, 
										통신 환경에 따라 음향 및 화면 중계가 고르지 않을 수 있는 점 양해 부탁드립니다.</span></li>
								</ul>
								<div class="product__details_orderform">
									...
									<a href="goodsCart" class="primary-btn">장바구니</a> <a
										href="goodsBuy" class="primary-btn"
										style="background-color: #022AD5;">바로예매</a>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
