      ...
      <form method="post" id="frm" action="${pageContext.request.contextPath}/audition/auditioninsertsend" encType="multipart/form-data">
            <div id="tab-5" class="tab-content">
               ...
               <table class="table table-hover">
                  <tr>
                     <td class="font-f">이름</td>
                     <td id="mem_uname"><input type='hidden' name='mem_name' value='${audition.mem_name}'></td>
                     <td></td>
                     <td></td>
                     <td></td>
                     <td></td>
                  ...
                  <tr>
                     ...
                     <td id="mem_ubranch"><input type='hidden' name='aud_type' value='${audition.aud_type}'></td>
                     <td></td>
                  ...
                  <tr>
                     ...
                     <td><input type='hidden' name='aud_age'></td>
