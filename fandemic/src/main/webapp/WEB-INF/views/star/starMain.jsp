			...
			<div class="author-image text img d-flex">
				<section class="home-slider js-fullheight owl-carousel">
					<div class="slider-item js-fullheight"
						style="background-image: url(resourcesStar/images/author.jpg);"></div>

					<div class="slider-item js-fullheight"
						style="background-image: url(resourcesStar/images/author-2.jpg);"></div>
				</section>
			</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-sm-12 col-md ftco-animate">
				<a href="resourcesStar/images/image_1.jpg" class="insta-img image-popup"
			...
			<div class="col-sm-12 col-md ftco-animate">
				<a href="resourcesStar/images/image_2.jpg" class="insta-img image-popup"
			...
			<div class="col-sm-12 col-md ftco-animate">
				<a href="resourcesStar/images/image_3.jpg" class="insta-img image-popup"
			...
			<div class="col-sm-12 col-md ftco-animate">
				<a href="resourcesStar/images/image_4.jpg" class="insta-img image-popup"
			...
			<div class="col-sm-12 col-md ftco-animate">
				<a href="resourcesStar/images/image_5.jpg" class="insta-img image-popup"
