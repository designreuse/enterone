				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								<li><a href="register.html"><i class="ion-person-add"></i><div>회 원 가 입</div></a></li>
				...
				<div class="container">
					...
					<div id="menu-list">
						<ul class="nav-list">
							...
							<li class="dropdown magz-dropdown"><a href="#">오 디 션 <i class="ion-ios-arrow-right"></i></a>
							...
							<li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">굿 즈 샵 <i class="ion-ios-arrow-right"></i></a>
