							...
							<thead>
								<tr>
									<th colspan="4"	style="background-color: #eeeeee; text-align: center;">
										<input type="hidden" name="nof_no" value="${notifyR.nof_no }"/>
										<input type="hidden" name="com_id" value="${company.com_id}"/>
										<input type="hidden" name="mem_id" value="${notifyR.mem_id }"/>
										<input type="hidden" name="st_id" value="${notifyR.st_id }" />
									</th>
								</tr>
							</thead>
							<tbody>
								<tr width="100%">
									...
									<td width="40%" align="left">								
				                         <input type="text" name="nof_content" class="form-control" value="${notifyR.nof_content}" 
				                              disabled="disabled"/>                 
				                        
									</td>
									<td><label>신고대상자</label></td>
									<td colspan="3"><input type="text" name="mem_id" class="form-control" value="${notifyR.mem_id}" disabled="disabled"> 
									</td>
								</tr>
								<tr width="100%">
									<td colspan="1" align="left"><label>신고자의스타</label></td>
									<td colspan="1"><input type="text" name="st_id" class="st_id form-control"
										value="${notifyR.st_id}" disabled="disabled"/>
									</td>
									<td><label>신고분류</label></td>
									<td colspan="1"><input type="text" name="nof_type" class="form-control" value="${notifyR.nof_type}" disabled="disabled"> 
									</td>
								</tr>
								<tr >
